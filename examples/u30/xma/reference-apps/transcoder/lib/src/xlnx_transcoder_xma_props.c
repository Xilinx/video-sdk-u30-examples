                                          ...
                                          XmaEncoderProperties*  xma_enc_props)
{
    ...
    xma_enc_props->params[param_cnt].name  = "disable_pipeline";
    xma_enc_props->params[param_cnt].type  = XMA_UINT32;
    xma_enc_props->params[param_cnt].length= sizeof(enc_props->disable_pipeline);
    xma_enc_props->params[param_cnt].value = &enc_props->disable_pipeline;
    param_cnt++;
                                      ...
                                      XmaFilterProperties*     xma_la_props)
{
    ...
    extn_params[param_cnt].type      = XMA_UINT32;
    extn_params[param_cnt].length    = sizeof(int);
    extn_params[param_cnt].value     = &la_props->dynamic_gop;
    param_cnt++;
